...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_tools_t, stringdata0) + ofs), len 
...
const QMetaObject tools::staticMetaObject = { {
    ...
    qt_meta_stringdata_tools.offsetsAndSize,
    qt_meta_data_tools,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_tools_t
