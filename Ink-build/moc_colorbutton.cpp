...
QT_MOC_LITERAL(26, 0), // ""
QT_MOC_LITERAL(27, 13) // "handleClicked"

    },
    "ColorButton\0buttonClicked\0\0handleClicked"
};
...
void ColorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->buttonClicked((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorButton::buttonClicked)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<ColorButton, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QColor, std::false_type>
...
// SIGNAL 0
void ColorButton::buttonClicked(QColor _t1)
{
